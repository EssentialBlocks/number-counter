...
/*!****************************************************!*\
  !*** ./src/constants/typographyPrefixConstants.js ***!
  \****************************************************/
/*! exports provided: title, number, numPrefix, numSuffix */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "numPrefix", function() { return numPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "numSuffix", function() { return numSuffix; });
var title = "title";
var number = "number";
var numPrefix = "prefix";
var numSuffix = "suffix";
...
var Edit = function Edit(props) {
  ...
  var resOption = attributes.resOption,
      ...
      MOBtitleColor = _attributes$MOBtitleC === void 0 ? MOBtitleColor || TABtitleColor : _attributes$MOBtitleC,
      _attributes$MOBnumber = attributes.MOBnumberColor,
      MOBnumberColor = _attributes$MOBnumber === void 0 ? MOBnumberColor || TABnumberColor : _attributes$MOBnumber,
      _attributes$MOBnumPre = attributes.MOBnumPrefixColor,
      MOBnumPrefixColor = _attributes$MOBnumPre === void 0 ? MOBnumPrefixColor || TABnumPrefixColor : _attributes$MOBnumPre,
      _attributes$MOBnumSuf = attributes.MOBnumSuffixColor,
      MOBnumSuffixColor = _attributes$MOBnumSuf === void 0 ? MOBnumSuffixColor || TABnumSuffixColor : _attributes$MOBnumSuf,
      ...
      MOBgapNumTitle = _attributes$MOBgapNum === void 0 ? MOBgapNumTitle || TABgapNumTitle : _attributes$MOBgapNum,
      _attributes$MOBgapNum2 = attributes.MOBgapNumPrefix,
      MOBgapNumPrefix = _attributes$MOBgapNum2 === void 0 ? MOBgapNumPrefix || TABgapNumPrefix : _attributes$MOBgapNum2,
      _attributes$MOBgapNum3 = attributes.MOBgapNumSuffix,
      MOBgapNumSuffix = _attributes$MOBgapNum3 === void 0 ? MOBgapNumSuffix || TABgapNumSuffix : _attributes$MOBgapNum3,
  ...
  var CounterAnimation = function CounterAnimation() {
    ...
    var timeoutId = setTimeout(function () {
      function updateCount() {
        ...
        counterRef.current.innerText = Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["textInsideForEdit"])(Math.floor(cleanStartValue), isShowSeparator, separator);
        ...
        if (cleanStartValue < endTarget) {
          ...
          counterRef.current.innerText = Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["textInsideForEdit"])(endTarget, isShowSeparator, separator);
        }
      }
  ...
  var generateTypographyStylesForEdit = function generateTypographyStylesForEdit(prefixConstant) {
    ...
    var fontFamily = attributes["".concat(prefixConstant, "FontFamily")],
        ...
        _attributes$5 = attributes["MOB".concat(prefixConstant, "FontFamily")],
        MOBfontFamily = _attributes$5 === void 0 ? MOBfontFamily || TABfontFamily : _attributes$5,
        _attributes$6 = attributes["MOB".concat(prefixConstant, "FontWeight")],
        MOBfontWeight = _attributes$6 === void 0 ? MOBfontWeight || TABfontWeight : _attributes$6,
        _attributes$7 = attributes["MOB".concat(prefixConstant, "TextTransform")],
        MOBtextTransform = _attributes$7 === void 0 ? MOBtextTransform || TABtextTransform : _attributes$7,
        _attributes$8 = attributes["MOB".concat(prefixConstant, "TextDecoration")],
        MOBtextDecoration = _attributes$8 === void 0 ? MOBtextDecoration || TABtextDecoration : _attributes$8,
        _attributes$9 = attributes["MOB".concat(prefixConstant, "FontSize")],
        MOBfontSize = _attributes$9 === void 0 ? MOBfontSize || TABfontSize : _attributes$9,
        _attributes$10 = attributes["MOB".concat(prefixConstant, "SizeUnit")],
        MOBsizeUnit = _attributes$10 === void 0 ? MOBsizeUnit || TABsizeUnit : _attributes$10,
        _attributes$11 = attributes["MOB".concat(prefixConstant, "LetterSpacing")],
        MOBletterSpacing = _attributes$11 === void 0 ? MOBletterSpacing || TABletterSpacing : _attributes$11,
        _attributes$12 = attributes["MOB".concat(prefixConstant, "LetterSpacingUnit")],
        MOBletterSpacingUnit = _attributes$12 === void 0 ? MOBletterSpacingUnit || TABletterSpacingUnit : _attributes$12,
        _attributes$13 = attributes["MOB".concat(prefixConstant, "LineHeight")],
        MOBlineHeight = _attributes$13 === void 0 ? MOBlineHeight || TABlineHeight : _attributes$13,
        _attributes$14 = attributes["MOB".concat(prefixConstant, "LineHeightUnit")],
        MOBlineHeightUnit = _attributes$14 === void 0 ? MOBlineHeightUnit || TABlineHeightUnit : _attributes$14;
    var typoStylesDesktop = "\n\t\t\t".concat(fontFamily ? "font-family: ".concat(fontFamily, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(fontSize) ? "font-size: ".concat(fontSize).concat(sizeUnit, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(lineHeight) ? "line-height: ".concat(lineHeight).concat(lineHeightUnit, ";") : " ", "\n\t\t\t").concat(fontWeight ? "font-weight: ".concat(fontWeight, ";") : " ", "\n\t\t\t").concat(textDecoration ? "text-decoration: ".concat(textDecoration, ";") : " ", "\n\t\t\t").concat(textTransform ? "text-transform: ".concat(textTransform, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(letterSpacing) ? "letter-spacing: ".concat(letterSpacing).concat(letterSpacingUnit, ";") : " ", "\n\t\t");
    var typoStylesTab = "\n\t\t\t".concat(TABfontFamily ? "font-family: ".concat(TABfontFamily, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(TABfontSize) ? "font-size: ".concat(TABfontSize).concat(TABsizeUnit, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(TABlineHeight) ? "line-height: ".concat(TABlineHeight).concat(TABlineHeightUnit, ";") : " ", "\n\t\t\t").concat(TABfontWeight ? "font-weight: ".concat(TABfontWeight, ";") : " ", "\n\t\t\t").concat(TABtextDecoration ? "text-decoration: ".concat(TABtextDecoration, ";") : " ", "\n\t\t\t").concat(TABtextTransform ? "text-transform: ".concat(TABtextTransform, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(TABletterSpacing) ? "letter-spacing: ".concat(TABletterSpacing).concat(TABletterSpacingUnit, ";") : " ", "\n\t\t");
    var typoStylesMobile = "\n\t\t\t".concat(MOBfontFamily ? "font-family: ".concat(MOBfontFamily, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(MOBfontSize) ? "font-size: ".concat(MOBfontSize).concat(MOBsizeUnit, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(MOBlineHeight) ? "line-height: ".concat(MOBlineHeight).concat(MOBlineHeightUnit, ";") : " ", "\n\t\t\t").concat(MOBfontWeight ? "font-weight: ".concat(MOBfontWeight, ";") : " ", "\n\t\t\t").concat(MOBtextDecoration ? "text-decoration: ".concat(MOBtextDecoration, ";") : " ", "\n\t\t\t").concat(MOBtextTransform ? "text-transform: ".concat(MOBtextTransform, ";") : " ", "\n\t\t\t").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["hasVal"])(MOBletterSpacing) ? "letter-spacing: ".concat(MOBletterSpacing).concat(MOBletterSpacingUnit, ";") : " ", "\n\t\t");
    return {
  ...
  var _generateTypographySt = generateTypographyStylesForEdit(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_5__["title"], 40),
  ...
  var _generateTypographySt2 = generateTypographyStylesForEdit(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_5__["number"], 40),
  ...
  var _generateTypographySt3 = generateTypographyStylesForEdit(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_5__["numPrefix"]),
  ...
  var _generateTypographySt4 = generateTypographyStylesForEdit(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_5__["numSuffix"]),
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])("essential-blocks-separate/counter", {
  ...
  keywords: [Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("EB counter", "essential-blocks"), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("counter", "essential-blocks"), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("counter up", "essential-blocks")],
...
/* harmony import */ var _util_gradient_color_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../util/gradient-color-controller */ "./util/gradient-color-controller/index.js");
/* harmony import */ var _util_image_avatar_ImageAvater__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../util/image-avatar/ImageAvater */ "./util/image-avatar/ImageAvater.js");
...
/* harmony import */ var _util_toggle_button__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../util/toggle-button */ "./util/toggle-button/index.js");
/* harmony import */ var _util_typography_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../util/typography-component */ "./util/typography-component/index.js");
/* harmony import */ var _ResPanelBody__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ResPanelBody */ "./src/ResPanelBody.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./constants */ "./src/constants.js");
/* harmony import */ var _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./constants/typographyPrefixConstants */ "./src/constants/typographyPrefixConstants.js");
/**
 * WordPress dependencies
 */
...
var Inspector = function Inspector(props) {
  ...
  var resOption = attributes.resOption,
      ...
      TABgapNumTitle = _attributes$TABgapNum === void 0 ? TABgapNumTitle === 0 ? TABgapNumTitle : TABgapNumTitle || gapNumTitle : _attributes$TABgapNum,
      _attributes$TABgapNum2 = attributes.TABgapNumPrefix,
      TABgapNumPrefix = _attributes$TABgapNum2 === void 0 ? TABgapNumPrefix === 0 ? TABgapNumPrefix : TABgapNumPrefix || gapNumPrefix : _attributes$TABgapNum2,
      _attributes$TABgapNum3 = attributes.TABgapNumSuffix,
      TABgapNumSuffix = _attributes$TABgapNum3 === void 0 ? TABgapNumSuffix === 0 ? TABgapNumSuffix : TABgapNumSuffix || gapNumSuffix : _attributes$TABgapNum3,
      _attributes$MOBgapNum = attributes.MOBgapNumTitle,
      MOBgapNumTitle = _attributes$MOBgapNum === void 0 ? MOBgapNumTitle === 0 ? MOBgapNumTitle : MOBgapNumTitle || TABgapNumTitle : _attributes$MOBgapNum,
      _attributes$MOBgapNum2 = attributes.MOBgapNumPrefix,
      MOBgapNumPrefix = _attributes$MOBgapNum2 === void 0 ? MOBgapNumPrefix === 0 ? MOBgapNumPrefix : MOBgapNumPrefix || TABgapNumPrefix : _attributes$MOBgapNum2,
      _attributes$MOBgapNum3 = attributes.MOBgapNumSuffix,
      MOBgapNumSuffix = _attributes$MOBgapNum3 === void 0 ? MOBgapNumSuffix === 0 ? MOBgapNumSuffix : MOBgapNumSuffix || TABgapNumSuffix : _attributes$MOBgapNum3,
      marginUnit = attributes.marginUnit,
      _attributes$marginTop = attributes.marginTop,
      marginTop = _attributes$marginTop === void 0 ? marginTop || 0 : _attributes$marginTop,
      _attributes$marginRig = attributes.marginRight,
      ...
      hoverInset = attributes.hoverInset,
      wrapperTransitionTime = attributes.wrapperTransitionTime; // this useEffect is for setting the resOption attribute to desktop/tab/mobile depending on the added 'eb-res-option-' class
  ...
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    var allCounterWrapper = document.querySelectorAll(".eb-guten-block-main-parrent-wrapper:not(.is-selected) > style");
    console.log("---inspector", {
      allCounterWrapper: allCounterWrapper
    });
    if (allCounterWrapper.length < 1) return;
    allCounterWrapper.forEach(function (styleTag) {
      var cssStrings = styleTag.textContent;
      var minCss = cssStrings.replace(/\s+/g, " ");
      var regexCssMimmikSpace = /(?<=edit_mimmikcss_start\s*\*\/).+(?=\/\*\s*edit_mimmikcss_end)/i;
      var newCssStrings = " ";

      if (resOption === "tab") {
        var tabCssMacth = minCss.match(/(?<=\@media\s+all\s+and\s+\(max-width\s*\:\s*1030px\s*\)\s*\{).+(?=\}\s*\@media\s+all)/i);
        var tabCssStrings = (tabCssMacth || [" "])[0]; // console.log({
        // 	tabCssStrings: tabCssStrings,
        // });

        newCssStrings = minCss.replace(regexCssMimmikSpace, tabCssStrings);
      } else if (resOption === "mobile") {
        var mobCssMacth = minCss.match(/(?<=\@media\s+all\s+and\s+\(max-width\s*\:\s*680px\s*\)\s*\{).+(?=(\}\s*)$)/i);
        var mobCssStrings = (mobCssMacth || [" "])[0]; // console.log({
  ...
  var titleTypoAttrr = generateTypographyAttributes(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["title"]); // console.log("------------title typo attributes", { titleTypoAttrr });
  ...
  return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["InspectorControls"], {
    ...
    options: _constants__WEBPACK_IMPORTED_MODULE_12__["LAYOUT_OPTIONS"],
    value: layoutLabel,
    onChange: function onChange(value) {
    ...
    options: _constants__WEBPACK_IMPORTED_MODULE_12__["SEPARATOR_OPTIONS"],
    value: separastorSelectLabel,
    onChange: function onChange(value) {
      return handleSeparatorChange(value);
    }
  })), /*#__PURE__*/React.createElement(_ResPanelBody__WEBPACK_IMPORTED_MODULE_11__["default"], {
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Typography"),
    initialOpen: false,
    resRequiredProps: resRequiredProps
  }, /*#__PURE__*/React.createElement(_util_typography_component__WEBPACK_IMPORTED_MODULE_10__["default"], {
    baseLabel: "Title",
    typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["title"],
    typographyAttributes: generateTypographyAttributes(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["title"]),
    resOption: resOption,
    setAttributes: setAttributes
  }), /*#__PURE__*/React.createElement(_util_typography_component__WEBPACK_IMPORTED_MODULE_10__["default"], {
    baseLabel: "Number",
    typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["number"],
    typographyAttributes: generateTypographyAttributes(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["number"]),
    resOption: resOption,
    setAttributes: setAttributes
  }), /*#__PURE__*/React.createElement(_util_typography_component__WEBPACK_IMPORTED_MODULE_10__["default"], {
    baseLabel: "Prefix",
    typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["numPrefix"],
    typographyAttributes: generateTypographyAttributes(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["numPrefix"]),
    resOption: resOption,
    setAttributes: setAttributes
  }), /*#__PURE__*/React.createElement(_util_typography_component__WEBPACK_IMPORTED_MODULE_10__["default"], {
    baseLabel: "Suffix",
    typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["numSuffix"],
    typographyAttributes: generateTypographyAttributes(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_13__["numSuffix"]),
    resOption: resOption,
    setAttributes: setAttributes
  })), /*#__PURE__*/React.createElement(_ResPanelBody__WEBPACK_IMPORTED_MODULE_11__["default"], {
    ...
    initialOpen: false,
    resRequiredProps: resRequiredProps
  }, resOption == "desktop" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  })), resOption == "tab" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Number"),
  ...
  })), resOption == "mobile" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Number"),
    ...
    initialOpen: false,
    resRequiredProps: resRequiredProps
  }, resOption == "desktop" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_unit_control__WEBPACK_IMPORTED_MODULE_5__["default"], {
    selectedUnit: marginUnit,
    unitTypes: _constants__WEBPACK_IMPORTED_MODULE_12__["FONT_SIZE_UNITS"],
  ...
  })), resOption == "tab" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_unit_control__WEBPACK_IMPORTED_MODULE_5__["default"], {
  ...
  })), resOption == "mobile" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_unit_control__WEBPACK_IMPORTED_MODULE_5__["default"], {
  ...
  }, /*#__PURE__*/React.createElement(ButtonGroup, null, _constants__WEBPACK_IMPORTED_MODULE_12__["BACKGROUND_TYPES"].map(function (_ref7) {
  ...
  }))), backgroundType === "fill" && /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    initialOpen: false
  }, /*#__PURE__*/React.createElement(_util_gradient_color_controller__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  }), imageURL && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_image_avatar_ImageAvater__WEBPACK_IMPORTED_MODULE_7__["default"], {
    imageUrl: imageURL,
  ...
  }, /*#__PURE__*/React.createElement(ButtonGroup, null, _constants__WEBPACK_IMPORTED_MODULE_12__["BACKGROUND_SIZES"].map(function (_ref9) {
    ...
    unitTypes: _constants__WEBPACK_IMPORTED_MODULE_12__["LETTER_SPACING_LINE_HEIGHT_UNITS"],
    ...
    value: borderStyle,
    options: _constants__WEBPACK_IMPORTED_MODULE_12__["BORDER_STYLES"],
  ...
  }, /*#__PURE__*/React.createElement(_util_toggle_button__WEBPACK_IMPORTED_MODULE_9__["default"], {
    options: _constants__WEBPACK_IMPORTED_MODULE_12__["SHADOW_HOVER_OPTIONS"],
    onChange: function onChange(value) {
      return setAttributes({
        shadowType: value
      });
    }
  })), shadowType === "normal" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  })), shadowType === "hover" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
/***/ "./util/typography-component/index.js":
/*!********************************************!*\
  !*** ./util/typography-component/index.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _util_typography_control_FontPicker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../util/typography-control/FontPicker */ "./util/typography-control/FontPicker.js");
...
function TypographyControllsDropdown(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, resOption == "desktop" && /*#__PURE__*/React.createElement(BaseControl, {
    label: __(baseLabel),
    ...
    renderToggle: function renderToggle(_ref2) {
      ...
      return /*#__PURE__*/React.createElement(Button, {
        ...
        onClick: onToggle,
        "aria-expanded": isOpen
      }, /*#__PURE__*/React.createElement(_util_icons__WEBPACK_IMPORTED_MODULE_0__["TypographyIcon"], null));
    },
    renderContent: function renderContent() {
      return /*#__PURE__*/React.createElement("div", {
        className: "eb-panel-control eb-typography-component-panel"
      }, /*#__PURE__*/React.createElement(_util_typography_control_FontPicker__WEBPACK_IMPORTED_MODULE_1__["default"], {
  ...
  })), resOption == "tab" && /*#__PURE__*/React.createElement(BaseControl, {
    label: __(baseLabel),
    className: "eb-typography-base"
  }, /*#__PURE__*/React.createElement(Dropdown, {
    className: "eb-typography-dropdown",
  ...
  })), resOption == "mobile" && /*#__PURE__*/React.createElement(BaseControl, {
    label: __(baseLabel),
    className: "eb-typography-base"
  }, /*#__PURE__*/React.createElement(Dropdown, {
    className: "eb-typography-dropdown",
