...
var Inspector = function Inspector(_ref) {
  ...
  var startValue = attributes.startValue,
      ...
      suffixLineHeightUnit = attributes.suffixLineHeightUnit,
      suffixLineHeight = attributes.suffixLineHeight;
  var isLinear = /linear\-gradient/i.test(gradientColor);
  console.log({
  ...
  var parseGradientColor = function parseGradientColor() {
    if (isLinear) {
      var angle = gradientColor.match(/\d{1,3}deg/gi);
      var colors = gradientColor.match(/\#[a-f\d]{6}|/gi);
      console.log({
        angle: angle,
        colors: colors
      });
...
var GradientColorControl = function GradientColorControl(_ref) {
  var bgGradientType = _ref.gradientType,
      firstColor = _ref.colorOne,
      grColorOnePosition = _ref.colorOnePosition,
      secondColor = _ref.colorTwo,
      grColorTwoPosition = _ref.colorTwoPosition,
      gradientAngle = _ref.angle,
      grRadialShape = _ref.radialShape,
      grRadialX = _ref.radialX,
      grRadialY = _ref.radialY,
      onChange = _ref.onChange;

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(bgGradientType || "linear"),
      _useState2 = _slicedToArray(_useState, 2),
