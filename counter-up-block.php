...
function create_block_counter_up_block_init()
{
	...
	if (!WP_Block_Type_Registry::get_instance()->is_registered('essential-blocks/counter-up')) {
		register_block_type('block/counter-up-block', array(
